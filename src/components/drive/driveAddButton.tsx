...
export default function DriveAddButton() {
  ...
  return (
    <>
      <ChooseFileModal
        open={openChooseFile}
        onClose={() => setOpenChooseFile(false)}
      />
      <DriveAddFolderModal
        open={openModalFolder}
        onClose={() => setOpenModalFolder(false)}
      ...
      <Popover
        ...
        content={
          <div className="flex flex-col gap-2">
            <Button
              className="flex items-center !justify-start gap-2 !bg-white hover:!bg-gray-200"
      ...
      >
        <Button
          className="!bg-white !shadow-md hover:!shadow-xl !h-16 md:w-24 w-full  !rounded-xl !font-semibold"
          size="large"
          variant="filled"
          color="default"
          icon={<PlusOutlined />}
