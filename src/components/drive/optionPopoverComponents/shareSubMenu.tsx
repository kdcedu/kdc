...
import CopyLinkNotification from "@/components/modal/copyLinkNotification";
...
export default function ShareSubMenu({ onOpenModal }: ShareSubMenuProps) {
  const { handleCopyLink, setVisibleNoti, visibleNoti } = useDrive();
  // const onAccess = (e: ReactMouseEvent<HTMLDivElement>) => {
  //   e.stopPropagation();
  //   onOpenModal();
  // };
