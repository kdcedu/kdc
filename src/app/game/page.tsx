...
export default function GamePage() {
  ...
  const setStateMap: Partial<{ [key in GameThings]: Dispatch<SetStateAction<string>> }> = {
    bed: setBed,
    picture: setPicture,
    desk: setDesk,
    window: setWindow,
  ...
  return (
    <div className="relative w-full">
      <GameModal open={openModal} setOpenModal={setOpenModal} currentThing={chosenThing} choseFunction={handleSelectItem} />

      <Image src="/backgrounds/gameBackground.jpg" alt="Game Background" preview={false}/>

      <div className="w-[38%] absolute top-[70%] left-[35%] transform -translate-x-1/2 -translate-y-1/2">
        <Image onClick={() => {
          handleItemClick("bed");
        }} src={`/games/${bed}_bed.png`} alt="Bed" preview={false}/>
        <div onClick={() => {
          handleItemClick("bed");
      ...
      <div className="w-[10%] absolute top-[38.5%] left-[22.5%] transform -translate-x-1/2 -translate-y-1/2">
        ...
        }} src={`/games/${picture}_picture.png`} alt="Picture" preview={false}/>
        <div onClick={() => {
          handleItemClick("picture");
      ...
      <div className="w-[26%] bg-transparent absolute top-[34%] left-[51.5%] transform -translate-x-1/2 -translate-y-1/2">
        ...
        }} src={`/games/${desk}_desk.png`} alt="Desk" preview={false}/>
        <div onClick={() => {
          handleItemClick("desk");
      ...
      <div className="w-[16%] h-[18%] absolute flex items-top top-[14.5%] left-[66.5%] transform -translate-x-1/2 -translate-y-1/2">
        ...
        }} src={`/games/${window}_window.png`} alt="Window" preview={false}/>
        <div onClick={() => {
          handleItemClick("window");
